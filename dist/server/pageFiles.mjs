...
const exportNames$k = ["Page", "documentProps"];
...
const pageFilesLazyServer1 = /* @__PURE__ */ Object.assign({ "/pages/community/index.page.server.tsx": () => import("./entries/pages_community_index-page-server.mjs"), "/pages/community/search/index.page.server.ts": () => import("./entries/pages_community_search_index-page-server.mjs"), "/pages/search/keyword/index.page.server.ts": () => import("./entries/pages_search_keyword_index-page-server.mjs"), "/pages/search/restaurant/index.page.server.ts": () => import("./entries/pages_search_restaurant_index-page-server.mjs"), "/pages/search/restaurant/reviews/create/index.page.server.ts": () => import("./entries/pages_search_restaurant_reviews_create_index-page-server.mjs"), "/pages/search/restaurant/reviews/edit/index.page.server.tsx": () => import("./entries/pages_search_restaurant_reviews_edit_index-page-server.mjs"), "/renderer/_default.page.server.tsx": () => import("./entries/renderer_default-page-server.mjs") });
const pageFilesLazyServer = { ...pageFilesLazyServer1 };
pageFilesLazy[".page.server"] = pageFilesLazyServer;
const pageFilesExportNamesEagerServer1 = /* @__PURE__ */ Object.assign({ "/pages/community/index.page.server.tsx": __vite_glob_3_0, "/pages/community/search/index.page.server.ts": __vite_glob_3_1, "/pages/search/keyword/index.page.server.ts": __vite_glob_3_2, "/pages/search/restaurant/index.page.server.ts": __vite_glob_3_3, "/pages/search/restaurant/reviews/create/index.page.server.ts": __vite_glob_3_4, "/pages/search/restaurant/reviews/edit/index.page.server.tsx": __vite_glob_3_5, "/renderer/_default.page.server.tsx": __vite_glob_3_6 });
